...
public class BaseActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		int id=0;
		if(currentActivityName.equals(getResources().getString(R.string.title_activity_activity__tasten))){
			id = R.id.mode_keys;
		}else if(currentActivityName.equals(getResources().getString(R.string.title_activity_activity__kippen))){
			id=R.id.mode_sweep;
		}
