...
public class Activity_Buttons extends Activity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) { //gets called right after app started
        ...
        setContentView(R.layout.activity_layout_buttons);    //set the layout, R is a generated class by Java, it's not allowed to edit it!
